...
const SCHED_SLOTS = [
  420, 450,             // 기상/샤워
  500,                  // 아침공부 — 7:30~8:20 한 줄
  530, 540,
  600, 660, 720,        // 1~3교시 — 한 교시가 한 줄
  770,                  // 4교시
  840,                  // 점심시간
  900, 960, 1020,       // 5~7교시
  1050, 1070, 1110, 1140, 1170, 1200,
...
const SCHED_DEFAULT_FILLS = [
  ...
  [SCHED_WEEKDAYS, [1, 1], '아침공부'],
  [SCHED_WEEKDAYS, [2, 2], '아침식사'],
  [SCHED_WEEKDAYS, [3, 3], '아침조회'],
  [SCHED_WEEKDAYS, [4, 4], '1교시'],
  [SCHED_WEEKDAYS, [5, 5], '2교시'],
  [SCHED_WEEKDAYS, [6, 6], '3교시'],
  [['월', '수', '금'], [7, 7], '4교시(자습)'],
  [['화', '목'], [7, 7], '4교시'],
  [SCHED_WEEKDAYS, [8, 8], '점심시간'],
  [SCHED_WEEKDAYS, [9, 9], '5교시'],
  [SCHED_WEEKDAYS, [10, 10], '6교시'],
  [['화'], [11, 11], '7교시'],
  [SCHED_WEEKDAYS, [13, 13], '종례'],
  [SCHED_WEEKDAYS, [14, 15], '저녁시간'],
  [['월', '화', '수', '목'], [16, 17], '비교과 활동'],
  [['금'], [16, 17], '귀가'],
  // 금요일 저녁은 귀가라 기숙사 일과(간식~취침)가 없다 — 목요일까지만 채운다
  [SCHED_DORM_DAYS, [19, 19], '간식타임'],
  [SCHED_DORM_DAYS, [24, 24], '샤워 및 하루일과 정리'],
  [SCHED_DORM_DAYS, [25, 25], 'Roll-Call / 취침'],
];
